...
return [
    ...
    */
    ...
    'email' => '正しい:attributeの形式で入力してください',
    'ends_with' => 'The :attribute field must end with one of the following: :values.',
    'enum' => 'The selected :attribute is invalid.',
    'exists' => '登録済の:attributeを入力してください',
    ...
    'max' => [
        ...
        'file' => ':attribute のサイズは :max キロバイト以下にして下さい',
        'numeric' => 'The :attribute field must not be greater than :max.',
        'string' => ':attribute は :max 文字以内で入力して下さい',
    ],
    'max_digits' => 'The :attribute field must not have more than :max digits.',
    'mimes' => ':attribute は :values のみです',
    ...
    'uploaded' => 'The :attributeのアップロードに失敗しました',
    ...
    */
    ...
    'attributes' => [
        ...
        'number'        => '機材型番',
        'age'           => 'オフィス築年数',
        'preferred_hr_st'   => 'シフト開始時刻（時）',
        'preferred_min_st'  => 'シフト開始時刻（分）',
        'preferred_hr_end'  => 'シフト開始時刻（時）',
        'preferred_min_end' => 'シフト開始時刻（分）',
        'employment_insurance_number' => '雇用保険適用事業所番号',
    ],
