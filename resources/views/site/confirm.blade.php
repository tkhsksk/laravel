      ...
      <div class="col-lg-9">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="form-horizontal r-separator" action="{{ route('site.store') }}" novalidate="novalidate" method="post">
              @csrf
              ...
              <div class="form-group mb-0">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">サイトURL</label>
              ...
              <div class="form-group mb-0">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">サイト名</label>
                  <div class="col-9 border-start pb-2 pt-2">
              ...
              <div class="form-group mb-5">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">サイト管理画面URL</label>
                  <div class="col-9 border-start pb-2 pt-2">
                    <p class="mb-0">{{ $inputs['url_admin'] }}</p>
                    <input type="hidden" name="url_admin" value="{{ $inputs['url_admin'] }}">
                  </div>
                </div>
              </div>

              <h4 class="card-title fw-semibold mb-3">各管理サイトについて</h4>

              <div class="form-group mb-0">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">サーバー管理</label>
                  <div class="col-9 border-start pb-2 pt-2">
                    <p class="mb-0">{!! $inputs['server_id'] ? App\Models\Site::getServer($inputs['server_id']) : '' !!}</p>
              ...
              <div class="form-group mb-0">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">db管理</label>
                  <div class="col-9 border-start pb-2 pt-2">
                    <p class="mb-0">{!! $inputs['db_id'] ? App\Models\Site::getDatabase($inputs['db_id']) : $yet !!}</p>
                    <input type="hidden" name="db_id" value="{{ $inputs['db_id'] }}">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group mb-5">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">ドメイン管理サイト</label>
                  <div class="col-9 border-start pb-2 pt-2">
                    <p class="mb-0">{!! $inputs['domain_site_id'] ?  App\Models\Site::getSite($inputs['domain_site_id']) : $yet !!}</p>
                    <input type="hidden" name="domain_site_id" value="{{ $inputs['domain_site_id'] }}">
                  </div>
                </div>
              </div>

              <h4 class="card-title fw-semibold mb-3">git operation list</h4>

              <div class="form-group mb-5 border-bottom-0">
                <div class="row align-items-center">
                  <p class="mb-0">{!! nl2br($inputs['git']) !!}</p>
                  <input type="hidden" name="git" value="{{ $inputs['git'] }}">
                </div>
              </div>

              <h4 class="card-title fw-semibold mb-3">サイトについてのメモ</h4>
