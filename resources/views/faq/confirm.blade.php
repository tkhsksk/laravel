      ...
      <div class="col-lg-9">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="form-horizontal r-separator" action="{{ route('faq.store') }}" novalidate="novalidate" method="post">
              @csrf
              ...
              <div class="form-group mb-0">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">最終更新者</label>
                  <div class="col-9 border-start pb-2 pt-2">
                    <p class="mb-0">{{ $inputs['updater_id'] ? getNamefromUserId($inputs['updater_id'],'A') : '新規の登録です' }}</p>
              ...
              <h4 class="card-title fw-semibold mb-3"><i class="ph ph-eyes me-2"></i>FAQの内容</h4>

              <div class="form-group mb-0">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">FAQの質問</label>
                  <div class="col-9 border-start pb-2 pt-2">
                    <p class="mb-0">{{ $inputs['question'] }}</p>
                    <input type="hidden" name="question" value="{{ $inputs['question'] }}">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group mb-0">
                <div class="row align-items-center">
                  <label for="inputText1" class="col-3 text-end control-label col-form-label">FAQの回答</label>
                  <div class="col-9 border-start pb-2 pt-2">
                    <div class="notification-body">
                      {!! $inputs['answer'] !!}
                    </div>
                    <input type="hidden" name="answer" value="{{ $inputs['answer'] }}">
                  </div>
                </div>
              </div>
