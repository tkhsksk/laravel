              ...
              <div class="d-flex flex-wrap justify-content-between">
                <div>
                  ...
                  <div class="d-flex align-items-center gap-6 flex-wrap mb-4">
                    ...
                    <h4 class="fw-semibold d-flex align-items-center mb-0 h6"><a href="/user/detail/{{ $shift->charger_id }}">承認者：{{ getNamefromUserId($shift->charger_id,'A') }}</a></h4>
                    <input type="hidden" name="charger_id" value="{{ $shift->charger_id }}">
                    @else
                    ...
                    <h4 class="fw-semibold d-flex align-items-center mb-0 h6"><a href="/user/detail/{{ Auth::user()->id }}">承認者：{{ getNamefromUserId(Auth::user()->id,'A') }}</a></h4>
                    <input type="hidden" name="charger_id" value="{{ Auth::user()->id }}">
                    @endif
                  </div>
                </div>
                ...
                <div>
                  <div class="d-flex align-items-center">
                    ...
                    @else
                    <span class="bg-{{ App\Models\Shift::STATUS['E'][1] }} p-1 rounded-circle"></span>
                    <p class="mb-0 ms-2">{{ App\Models\Shift::STATUS['E'][0] }}</p>
                    @endif
                  </div>
                  <p class="text-muted mb-0">申請日：{{ $shift ? $shift->created_at->format('Y/n/j') : now()->format('Y/n/j').'（本日）' }}</p>
                ...
                <div class="card-body p-md-2 p-0">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="card mb-0">
                        <div class="card-body">
                          <h5 class="card-title fw-semibold">{!! $required_badge !!}対象者の選択</h5>
                          <p class="card-subtitle mb-4">対象ユーザーを左のボックスから選択して下さい</p>
                          <div class="">
                          <form id="equipments_form" action="#" method="post">
                            @csrf
                            <select size="" name="register_id">
                          ...
                          <script>
                            var charger_check = $('select[name="register_id"]')
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <div>
                        ...
                        <div class="d-flex align-items-center">
                          <span class="bg-{{ App\Models\Shift::STATUS['E'][1] }} p-1 rounded-circle"></span>
                          <p class="mb-0 ms-2 fs-4">{{ App\Models\Shift::STATUS['E'][0] }}</p>
                        </div>
