;(function ($, window, document, undefined) {
  ...
  function bindEvents(dualListbox) {
    ...
    dualListbox.elements.filterInput1.on('change keyup', function() {
      filter(dualListbox, 1);
      if(dualListbox.elements.filterInput1.val().length > 0){
        dualListbox.elements.filterClear1.removeClass('d-none');
      } else {
        dualListbox.elements.filterClear1.addClass('d-none');
      }
    });

    dualListbox.elements.filterInput2.on('change keyup', function() {
      filter(dualListbox, 2);
      if(dualListbox.elements.filterInput2.val().length > 0){
        dualListbox.elements.filterClear2.removeClass('d-none');
      } else {
        dualListbox.elements.filterClear2.addClass('d-none');
      }
    });
  }
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        ' <div class="box1">' +
        '   <label class="fs-4 fw-semibold text-dark"></label>' +
        '   <span class="info-container">' +
        '     <span class="info"></span>' +
        '   </span>' +
        '   <div class="position-relative input-group mb-3 mt-2">' +
        '   <input class="filter form-control my-0 ps-5" type="text">' +
        '   <i class="ph ph-magnifying-glass position-absolute top-50 start-0 translate-middle-y fs-6 text-dark ms-3"></i>' +
        '     <button type="button" class="btn clear1 bg-primary-subtle text-primary rounded-end mb-0 fs-3"></button>' +
        '   </div>' +
        '   <div class="btn-group buttons">' +
        '     <button type="button" class="btn moveall bg-primary-subtle text-primary mb-2 fs-2">' +
        '       すべて追加<i class="d-none"></i>' +
        '       <i class="d-none"></i>' +
        '     </button>' +
        '     <button type="button" class="btn move d-none">' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
        ...
        '   <input class="filter form-control my-0 ps-5" type="text">' +
        '   <i class="ph ph-magnifying-glass position-absolute top-50 start-0 translate-middle-y fs-6 text-dark ms-3"></i>' +
        '     <button type="button" class="btn clear2 bg-primary-subtle text-primary rounded-end mb-0 fs-3"></button>' +
        '   </div>' +
        '   <div class="btn-group buttons">' +
        '     <button type="button" class="btn remove d-none">' +
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn removeall bg-primary-subtle text-primary mb-2 fs-2">' +
        '       すべて削除<i class="d-none"></i>' +
        '       <i class="d-none"></i>' +
        '     </button>' +
        '   </div>' +
        '   <select multiple="multiple"></select>' +
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.box1').removeClass('span6').addClass('col-md-6 mb-md-0 mb-3');
        this.container.find('.box2').removeClass('span6').addClass('col-md-6');
        this.container.find('.clear1, .clear2').removeClass('btn-mini');
